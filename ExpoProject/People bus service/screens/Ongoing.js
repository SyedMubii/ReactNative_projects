...
const Ongoing = () => {
  return (
    ...
    >
      <Text style={[styles.locationTargeting, styles.hyderabadFlexBox]}>
        Location targeting
      </Text>
      ...
      >
        <Text
          style={[styles.hangingAdsasdAsdasdasd, styles.hyderabadFlexBox]}
        >{`Hanging adsasd
asdasdasd`}</Text>
        <Image
          style={styles.frameChild}
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/buses.png")}
      />
      <Image
        style={styles.ongoingChild}
        contentFit="cover"
        source={require("../assets/ellipse-265.png")}
      />
      <View style={styles.search}>
        <Text style={[styles.hyderabad, styles.frameChildLayout]}>
          Hyderabad
        </Text>
        <Image
