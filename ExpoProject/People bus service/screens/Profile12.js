    ...
    <View style={styles.profile12}>
      <View style={styles.frameNave}>
        <View style={[styles.instanceParent, styles.parentLayout]}>
          <Image
            style={[styles.frameChild, styles.popularPosition]}
            contentFit="cover"
          ...
          <View style={[styles.homeParent, styles.parentLayout]}>
            ...
            <Pressable
              style={[styles.schedule, styles.popularPosition]}
      ...
      <View style={styles.citiesSection}>
        ...
        <View style={[styles.popularCity, styles.popularPosition]}>
        ...
        >
          <Text style={[styles.text2, styles.textFlexBox]}>
            <Text style={styles.bookYourFirstContainer1}>
              ...
              <Text style={[styles.firstRide, styles.text3Typo]}>
                First Ride
              </Text>
...
us and get the discount`}</Text>
        ...
        <Pressable
          ...
          onPress={() => navigation.navigate("Profile15")}
        >
          <Text style={[styles.text3, styles.text3Typo]}>20%</Text>
        </Pressable>
        <Pressable
          style={[styles.weekDeals, styles.actionPosition]}
          onPress={() => navigation.navigate("Profile15")}
        >
          <Text style={[styles.weekDeals1, styles.text3Typo]}>Week Deals!</Text>
        </Pressable>
        <Pressable
        ...
        <Pressable
          style={[styles.seeAll, styles.popularPosition]}
          onPress={() => navigation.navigate("Profile15")}
        >
      ...
      <View style={[styles.profileIcons, styles.actionPosition]}>
        ...
        <Pressable
          style={styles.lenaRose}
          onPress={() => navigation.navigate("ProfilePage")}
        >
          <Text style={[styles.lenaRose1, styles.lenaRose1FlexBox]}>
            Lena Rose
          </Text>
        </Pressable>
        <Text style={[styles.goodMorning, styles.lenaRose1FlexBox]}>
          Good Morning
        </Text>
        <Pressable
          style={[styles.container, styles.popularPosition]}
          onPress={() => navigation.navigate("ProfilePage")}
        >
          <Image
